...
def  predict(): 
    if request.method == 'POST':
        ...
        cur = conn.cursor()
        data = (age,flight_distance,inflight_entertainment,baggage_handling,cleanliness,departure_delay,arrival_delay,gender,customer_type,travel_type,economy,economy_plus,output)
